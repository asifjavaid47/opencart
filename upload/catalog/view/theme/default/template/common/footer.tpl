...
<div class="about-block-main">
       ...
       <div class="fine-what-container">
           <div class="container">
              ...
              <?php 
                ...
                //echo "<pre>"; print_r($level_one_category1); echo "<pre>";
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                $i = 0;
                   foreach($level_one_category as $category){
                     echo $i == 0?'<div class="col-sm-2 col-md-2 col-lg-2">':'';
                   ?>		
                ...
                <div class="col-sm-2 col-md-2 col-lg-2">
                    <span style="display: block;height: 281px;border-right: 1px solid #B4B4B4;"></span>
                </div>
                ...
                $j = 0;
                   foreach($level_one_category1 as $category){
                     echo $j == 0?'<div class="col-sm-2 col-md-2 col-lg-2">':'';
                   ?>		
       ...
       <div class="footer-main" style="margin-top:48px;">
           <div class="container">
               <div class="row">
                   <div class="col-sm-3 col-md-3 col-lg-3">
                   ...
                   <div class="col-sm-9 col-md-9 col-lg-9 border-line-block">
                       ...
                       <div class="row">
                           ...
                           <div class="col-sm-12">
                               ...
                               <div class="information-content">
                                   <div class="information-con-one">
                                       <a href="<?php echo $base; ?>index.php?route=account/termofuse"><i class="fa fa-circle-o"></i> Terms of use</a>
                                   </div>
                                   <div class="information-con-one">
                                       <a href="<?php echo $base; ?>index.php?route=account/privacy"><i class="fa fa-circle-o"></i> Privacy Policy</a>
                                   </div>
                                   <div class="information-con-one">
                                       <a href="mailto:contacto@xcantidad.com?Subject=Contact Us" target="_top"><i class="fa fa-circle-o"></i> Contact Us</a>
                                   </div>
