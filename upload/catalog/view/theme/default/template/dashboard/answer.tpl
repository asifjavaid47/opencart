    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav pull-right">
                ...
                <li>
                    <a href="questions.html">Answers</a>
                </li>
                <li>
...
<div class="col-sm-9 midbox">
    ...
    <div class="col-sm-9 midbox">
	 ...
	 // exit;
        ...
        foreach($user_pro_que_ans as $user_product){
			 ...
			 $number_of_ans_ques = sizeof($user_product['ans_que']);
             if(isset($user_product['ans_que'][$number_of_ans_ques-1]['question']))
             {
      ...
      <div class="question-block">
                            ...
                            {   
                                if(isset($user_product['ans_que'][$i]['question']))
                                {
                                    ...
                                    <div class="first-question">
                                        ...
                                        <div id="<?php echo $user_product['ans_que'][$i]['question_id']; ?>"  class="get_question_id-<?php  echo $user_product['product_id'];  ?> ques-txt-block">
                                            <?php
                    ...
                    ?>
                    <span style="float:right; cursor:pointer;" class="delete_question" id="del_question-<?php  echo $user_product['product_id'];?>">Delete question</span>
                </div>
				<form action="<?php echo $addanswerAction;?>" id="ans_form" name="" method="POST">
			...
			<div class="col-sm-3">		
				<button type="button" id="ans_form_submit-<?php echo $user_product['product_id']; ?>" class="btn btn-default ans_form_submit">Ask</button>
    ...
    var question_elements = $('.get_question_id-'+qusetion_id[1]);
    console.log(question_elements);
    total_lenght=question_elements.length;
     del_question_id=question_elements[total_lenght-1].id;
        $.ajax({
         type:"POST",
      ...
      $(".ans_form_submit").click(function(){
        var qusetion_id=$(this).attr("id");
        qusetion_id=qusetion_id.split("-");
        var question_elements = $('.get_question_id-'+qusetion_id[1]);
        total_lenght=question_elements.length;
        question_id=question_elements[total_lenght-1].id;
