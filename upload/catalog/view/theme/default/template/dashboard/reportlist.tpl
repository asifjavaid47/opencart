<?php echo $header;  ?>
	...
	foreach($reported_products  as $products){
	  ...
	  <div class="col-sm-9">
		...
		<label><?php echo $reported_address[$aa]['v_phone']; ?></label><br />
		<label><?php echo $reported_address[$aa]['v_email']; ?></label><br />
		<p><?php echo $reported_address[$aa]['address'];   ?> </p><br />
		<a href="index.php?route=dashboard/dashboardreport&xds=<?php echo $products['product_id'];?>">View Details</a>
	  </div>
	  </div>
	  </div>
	  <?php $aa++; } ?>
