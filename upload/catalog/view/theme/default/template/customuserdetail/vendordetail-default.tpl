            ...
            <div class="common-content">
                   ...
                   <!-- <div class="form-group col-sm-6">
                    ...
                    <div class="form-group col-sm-6 height_75">
                        ...
                        <input type="text" class="form-control vnumbersOnlyphone" id="phone" placeholder="Phone" onkeypress=" return isNumber(event);"  name="phone" value="<?php echo $phone;?>" />
                    ...
                    <div class="form-group col-sm-6 height_75">
                     ...
                     <div class="form-group col-sm-6 height_75">
                    	<label for="address"><?php echo $address_labl;?></label>
                    ...
                    <div class="form-group col-sm-6 height_75">
                        ...
                        <input type="text" name="city" class="form-control" placeholder="City" value="<?php echo $city; ?>" id="input-city" />
                    ...
                    <div class="form-group col-sm-6 ">
                       <label for="province"><?php echo $province_labl; ?></label>
                       <select name="zone_id" id="input-zone" class="form-control">
                       </select>
                       <?php if ($error_userdet_zone) { ?>
                       <div class="text-danger"><?php echo $error_userdet_zone; ?></div>
                       <?php } ?>                      
                    </div>
...
//$('.vnumbersOnlyphone').on('keyup', function(e) {
