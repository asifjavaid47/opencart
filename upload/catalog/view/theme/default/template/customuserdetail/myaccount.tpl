      ...
      <div class="min-height">
         <div class="container">
            ...
            <div class="sideoptions">
            	<ul>
                	<li class="active"><a href="<?php echo $base; ?>index.php?route=customuserdetail/myaccount"><i class="fa fa-user" aria-hidden="true"></i> My account</a></li>
            ...
            <div class="common-content">
            	<div class="main-heading" style="padding:15px;"> My account details</div>
                	<div class="section-heading" style="padding:15px;">My account </div>
