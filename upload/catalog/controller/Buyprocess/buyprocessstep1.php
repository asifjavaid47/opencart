...
class ControllerBuyprocessbuyprocessstep1 extends Controller {
	...
	public function get_vendor_details()
	{
        ...
        public function place_order(){
            $this->load->model("buyprocess/buyprocess");
            $data['product_id_final']=  $this->request->post['product_id_final'];
            $data['seller_id']= $this->model_buyprocess_buyprocess->get_seller_data($data['product_id_final']);
            $data['buyer_id']=$this->customer->getId();
            $data['quantity']=  $this->request->post['quantity'];
            $data['subtotal']=  $this->request->post['subtotal'];
            $data['shiping_charges']=  $this->request->post['shiping_charges'];
            $data['total']=  $this->request->post['total'];
            $data['deliverymethod']=  $this->request->post['deliverymethod'];
            $data['paymentmethod']=  $this->request->post['paymentmethod'];
            $data['product_image']=  $this->request->post['product_image'];
            $data['save_amount']=  $this->request->post['save_amount'];
            $data['ship_address']=  $this->request->post['ship_address'];
            $this->model_buyprocess_buyprocess->sale_purchase_record($data);
