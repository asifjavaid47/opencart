...
//           return $query->row['total'];
            ...
            $sql .= " LEFT JOIN " . DB_PREFIX . "product_description pd ON (p.product_id = pd.product_id) LEFT JOIN " . DB_PREFIX . "product_to_store p2s ON (p.product_id = p2s.product_id) $res  INNER JOIN `shipping_method_lc` AS sm 
